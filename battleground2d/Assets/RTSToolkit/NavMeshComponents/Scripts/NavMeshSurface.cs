...
//     [HelpURL("https://github.com/Unity-Technologies/NavMeshComponents#documentation-draft")]
    public class NavMeshSurface : MonoBehaviour
    {
        ...
        public void BuildNavMesh(Bounds inputBounds)
        {
            var sources = CollectSources();
...
//             }
			sources.Clear();
            var data = NavMeshBuilder.BuildNavMeshData(GetBuildSettings(),
                    sources, inputBounds, transform.position, transform.rotation);
        ...
        public AsyncOperation UpdateNavMesh(NavMeshData data, Bounds inputBounds)
        {
            var sources = CollectSources();
...
//             		if(ignores[j] == sources[i].transform){
//             			if(isAdded == false){
//             				removals.Add(sources[i]);
//             				isAdded = true;
//             			}
//             		}
//             	}
...
//                 sourcesBounds = CalculateWorldBounds(sources);
            ...
            return NavMeshBuilder.UpdateNavMeshDataAsync(data, GetBuildSettings(), sources, inputBounds);
        }
